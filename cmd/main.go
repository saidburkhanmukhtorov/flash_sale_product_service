...
func main() {
	...
	product_service.RegisterFlashSaleEventServiceServer(s, service.NewFlashSaleEventService(pgStorage))
	product_service.RegisterProductDiscountServiceServer(s, service.NewProductDiscountService(pgStorage))
